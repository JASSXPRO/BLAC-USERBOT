...
async def amireallyalive(alive):
    ...
    if MAFIA_IMG:
        ...
        SAVAGE_caption += f"✰ 𝙱𝙻𝙰𝙲 𝚅𝙴𝚁𝚂𝙸𝙾𝙽 : `{SAVAGEversion}`\n\n"
        SAVAGE_caption += f"✰ 𝙼𝚈 𝙱𝙾𝚂𝚂 : {mention}\n\n"
        SAVAGE_caption += f"✰ 𝚂𝚄𝙿𝙿𝙾𝚁𝚃 : [𝙶𝚁𝙾𝚄𝙿](https://t.me/BLACUSERBOT_PUBLIC)\n\n"
        ...
        await edit_or_reply(
            ...
            f"✰ 𝙱𝙻𝙰𝙲 𝚅𝙴𝚁𝚂𝙸𝙾𝙽 :**`{SAVAGEversion}`\n\n"
            f"✰ 𝙼𝚈 𝙱𝙾𝚂𝚂 :** {mention}\n\n"
            f"✰ 𝚂𝚄𝙿𝙿𝙾𝚁𝚃 : [𝙶𝚁𝙾𝚄𝙿](https://t.me/BLACUSERBOT_PUBLIC)\n\n"
            f"✰ 𝚄𝙿 𝚃𝙸𝙼𝙴 : `{uptime}\n`"
        )               
